manhattantourist1 <- function(n, m, Down, Right) {
...
##   right <- rbind(rightrow1, rightrow2, rightrow3, rightrow4, rightrow5)
  ...
  down <- readmatrixfromfile("datasets/down2.txt")
  right <- readmatrixfromfile("datasets/right2.txt")  
  
  s <- manhattantourist1(n, m, down, right)
